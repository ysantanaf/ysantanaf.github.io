...
const DatetimeButton = class {
                    ...
                    if (multiple && parsedValues.length !== 1) {
                        ...
                        if (titleSelectedDatesFormatter !== undefined) {
                            try {
                                ...
                                index$1.printIonError('[ion-datetime-button] - Exception in provided `titleSelectedDatesFormatter`:', e);
                            }
                        }
    ...
    async componentWillLoad() {
        const { datetime } = this;
        if (!datetime) {
            index$1.printIonError('[ion-datetime-button] - An ID associated with an ion-datetime instance is required to function properly.', this.el);
            return;
        }
        const datetimeEl = (this.datetimeEl = document.getElementById(datetime));
        if (!datetimeEl) {
            index$1.printIonError(`[ion-datetime-button] - No ion-datetime instance found for ID '${datetime}'.`, this.el);
            return;
        }
        /**
        ...
        if (datetimeEl.tagName !== 'ION-DATETIME') {
            index$1.printIonError(`[ion-datetime-button] - Expected an ion-datetime instance for ID '${datetime}' but received '${datetimeEl.tagName.toLowerCase()}' instead.`, datetimeEl);
            return;
        }
        /**
