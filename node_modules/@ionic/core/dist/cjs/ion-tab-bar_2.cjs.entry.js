...
const TabBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '62303a7f9d8c98ffab51a5900c144c5117b9c543', role: "tablist", "aria-hidden": shouldHide ? 'true' : null, class: theme.createColorClasses(color, {
                [mode]: true,
                'tab-bar-translucent': translucent,
                'tab-bar-hidden': shouldHide,
            }) }, index.h("slot", { key: '5771a9828f748c2bd6b5e26758b9723c6b3de5ff' })));
    }
...
const TabButton = class {
    ...
    componentWillLoad() {
        ...
        if (this.layout === undefined) {
            this.layout = index$1.config.get('tabButtonLayout', 'icon-top');
        }
    }
    selectTab(ev) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a86d441d8df350fe991f2f948fc6b6ad007728f7', onClick: this.onClick, onKeyup: this.onKeyUp, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
                [mode]: true,
