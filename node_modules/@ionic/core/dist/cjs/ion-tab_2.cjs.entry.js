...
const Tab = class {
    ...
    prepareLazyLoaded() {
        if (!this.loaded && this.component != null) {
            ...
            try {
                ...
                index$1.printIonError('[ion-tab] - Exception in prepareLazyLoaded:', e);
            }
        }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c36c113e74e12b58459df9e3b546ad4856187e90', role: "tabpanel", "aria-hidden": !active ? 'true' : null, "aria-labelledby": `tab-button-${tab}`, class: {
                'ion-page': component === undefined,
                'tab-hidden': !active,
            } }, index.h("slot", { key: '0d7821dac70ba7a12edfb3331988f3df1566cc1a' })));
    }
...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '20b97196d78c1b3f3faf31618a8a2347e087f06b', onIonTabButtonClick: this.onTabClicked }, index.h("slot", { key: 'b0823fbae6e47743cfd12c376b365ad7e32cec7c', name: "top" }), index.h("div", { key: 'eaffd7e4d69ab9489a387e3bbb36e3bab72203a0', class: "tabs-inner" }, index.h("slot", { key: '20bb66a2937e3ec473aa59c4075ce581b5411677' })), index.h("slot", { key: '1529dd361f050f52074f51c73b3982ba827dc3a5', name: "bottom" })));
    }
    get el() { return index.getElement(this); }
};
const getTab = (tabs, tab) => {
    ...
    if (!tabEl) {
        index$1.printIonError(`[ion-tabs] - Tab with id: "${tabEl}" does not exist`);
    }
    return tabEl;
};
