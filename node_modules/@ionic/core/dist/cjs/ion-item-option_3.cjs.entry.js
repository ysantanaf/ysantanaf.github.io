...
const ItemSliding = class {
    ...
    onMove(gesture) {
        ...
        switch (this.sides) {
            ...
            case 0 /* ItemSide.None */:
                return;
            default:
                index$2.printIonWarning('[ion-item-sliding] - invalid ItemSideFlags value', this.sides);
                break;
        }
        let optsWidth;
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'f8aea4bb9802b111ef358cc6c172a635637ae1f8', class: {
                [mode]: true,
