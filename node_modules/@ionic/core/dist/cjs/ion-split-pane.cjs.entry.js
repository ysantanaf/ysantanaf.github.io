...
const SplitPane = class {
    ...
    styleMainElement() {
        ...
        for (let i = 0; i < nu; i++) {
            ...
            if (isMain) {
                if (foundMain) {
                    index$1.printIonWarning('[ion-split-pane] - Cannot have more than one main node.');
                    return;
                }
                else {
        ...
        if (!foundMain) {
            index$1.printIonWarning('[ion-split-pane] - Does not have a specified main node.');
        }
    }
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '098801b5a318e2fc6913fb0d9079b1552927b99b', class: {
                [mode]: true,
                // Used internally for styling
                [`split-pane-${mode}`]: true,
                'split-pane-visible': this.visible,
            } }, index.h("slot", { key: '8cbc6a942ecba54fc3c62027d46917db067b65c8' })));
    }
