...
const Spinner = class {
    ...
    getName() {
        const spinnerName = this.name || index$1.config.get('spinner');
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e0dfa8a3ee2a0469eb31323f506750bd77d65797', class: theme.createColorClasses(self.color, {
                [mode]: true,
                [`spinner-${spinnerName}`]: true,
                'spinner-paused': self.paused || index$1.config.getBoolean('_testing'),
